...
#ifndef PROTOBUF_game_5fcarsmagnate_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fcarsmagnate_5fdef_2eproto__INCLUDED
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_carsmagnate_protocols::e_server_msg_type>() {
  return ::game_carsmagnate_protocols::e_server_msg_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_carsmagnate_protocols::e_game_state>() {
  return ::game_carsmagnate_protocols::e_game_state_descriptor();
}
...
#endif  // PROTOBUF_game_5fcarsmagnate_5fdef_2eproto__INCLUDED
