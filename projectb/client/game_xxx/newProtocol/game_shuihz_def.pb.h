...
#ifndef PROTOBUF_game_5fshuihz_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fshuihz_5fdef_2eproto__INCLUDED
...
class msg_player_info : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:game_shuihz_protocols.msg_player_info)
 private:
  ...
  friend void  protobuf_AddDesc_game_5fshuihz_5fdef_2eproto();
  friend void protobuf_AssignDesc_game_5fshuihz_5fdef_2eproto();
  friend void protobuf_ShutdownFile_game_5fshuihz_5fdef_2eproto();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_shuihz_protocols::e_server_msg_type>() {
  return ::game_shuihz_protocols::e_server_msg_type_descriptor();
}
...
#endif  // PROTOBUF_game_5fshuihz_5fdef_2eproto__INCLUDED
