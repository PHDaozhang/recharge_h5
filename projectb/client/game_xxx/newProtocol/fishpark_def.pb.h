...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::fishpark_protocols::e_server_msg_type>() {
  return ::fishpark_protocols::e_server_msg_type_descriptor();
}
...
#endif  // PROTOBUF_fishpark_5fdef_2eproto__INCLUDED
