...
module('game_fourcolorball_def_pb')
...
E_SERVER_MSG_TYPE.full_name = ".game_fourcolorball_protocols.e_server_msg_type"
...
E_GAME_STATE.full_name = ".game_fourcolorball_protocols.e_game_state"
