...
E_FLOWER_TYPE = protobuf.EnumDescriptor();
E_FLOWER_TYPE_EFT_BLACK_ENUM = protobuf.EnumValueDescriptor();
E_FLOWER_TYPE_EFT_RED_ENUM = protobuf.EnumValueDescriptor();
E_FLOWER_TYPE_EFT_PLUM_ENUM = protobuf.EnumValueDescriptor();
E_FLOWER_TYPE_EFT_BLOCK_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE = protobuf.EnumDescriptor();
E_CARD_TYPE_ECT_UNKNOW_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_HIGH_CARD_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_ONE_PAIR_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_TWO_PAIRS_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_THREE_OF_A_KIND_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_STRAIGHT_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_FLUSH_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_THREE_ADD_TWO_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_FOUR_OF_A_KIND_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_STRAIGHT_FLUSH_ENUM = protobuf.EnumValueDescriptor();
E_CARD_TYPE_ECT_ROYAL_FLUSH_ENUM = protobuf.EnumValueDescriptor();
...
E_SERVER_MSG_TYPE_E_MST_C2L_GAME_CONTROL_ENUM.index = 16
...
E_SERVER_MSG_TYPE_E_MST_C2L_LEAVE_LIST_BANKER_ENUM.index = 17
E_SERVER_MSG_TYPE_E_MST_C2L_LEAVE_LIST_BANKER_ENUM.number = 10017
E_SERVER_MSG_TYPE_E_MST_C2L_ASK_PLAYERLIST_ENUM.name = "e_mst_c2l_ask_playerlist"
E_SERVER_MSG_TYPE_E_MST_C2L_ASK_PLAYERLIST_ENUM.index = 18
E_SERVER_MSG_TYPE_E_MST_C2L_ASK_PLAYERLIST_ENUM.number = 10018
E_SERVER_MSG_TYPE_E_MST_START_L2C_ENUM.name = "e_mst_start_l2c"
E_SERVER_MSG_TYPE_E_MST_START_L2C_ENUM.index = 19
...
E_SERVER_MSG_TYPE_E_MST_L2C_ENTER_ROOM_RESULT_ENUM.index = 21
...
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_ROOM_RESULT_ENUM.index = 22
...
E_SERVER_MSG_TYPE_E_MST_L2C_ADD_BET_ENUM.index = 23
...
E_SERVER_MSG_TYPE_E_MST_L2C_REPEAT_BET_ENUM.index = 24
...
E_SERVER_MSG_TYPE_E_MST_L2C_CLEAR_BET_ENUM.index = 25
...
E_SERVER_MSG_TYPE_E_MST_L2C_BC_BEGIN_BET_ENUM.index = 26
...
E_SERVER_MSG_TYPE_E_MST_L2C_BC_BEGIN_AWARD_ENUM.index = 27
...
E_SERVER_MSG_TYPE_E_MST_L2C_BC_TOTAL_BET_INFO_ENUM.index = 28
...
E_SERVER_MSG_TYPE_E_MST_L2C_GET_ROOM_SCENE_INFO_ENUM.index = 29
...
E_SERVER_MSG_TYPE_E_MST_L2C_CHECK_STATE_RESULT_ENUM.index = 30
...
E_SERVER_MSG_TYPE_E_MST_L2C_BC_ACCEPT_GIFT_ENUM.index = 31
...
E_SERVER_MSG_TYPE_E_MST_L2C_ASK_FOR_BANKER_ENUM.index = 32
...
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_BANKER_ENUM.index = 33
...
E_SERVER_MSG_TYPE_E_MST_L2C_ASK_FIRST_FOR_BANKER_ENUM.index = 34
...
E_SERVER_MSG_TYPE_E_MST_L2C_BC_CHANGE_BANKER_ENUM.index = 35
...
E_SERVER_MSG_TYPE_E_MST_L2C_ASK_PLAYER_LIST_ENUM.index = 36
...
E_SERVER_MSG_TYPE_E_MST_L2C_ASK_BANKER_LIST_ENUM.index = 37
...
E_SERVER_MSG_TYPE_E_MST_L2C_ASK_HISTORY_LIST_ENUM.index = 38
...
E_SERVER_MSG_TYPE_E_MST_L2C_BC_ROB_BANKER_INFO_ENUM.index = 39
...
E_SERVER_MSG_TYPE_E_MST_L2C_GAME_CONTROL_ENUM.index = 42
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_GM_BANK_INFO_ENUM.index = 43
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_GM_BANK_INFO_ENUM.number = 15027
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_LIST_BANKER_ENUM.name = "e_mst_l2c_leave_list_banker"
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_LIST_BANKER_ENUM.index = 44
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_LIST_BANKER_ENUM.number = 15028
E_SERVER_MSG_TYPE_E_MST_ATTENTION_NEEDLEAVE_ENUM.name = "e_mst_attention_needLeave"
E_SERVER_MSG_TYPE_E_MST_ATTENTION_NEEDLEAVE_ENUM.index = 45
...
E_GAME_STATE.full_name = ".game_multitexas_protocols.e_game_state"
...
E_FLOWER_TYPE_EFT_BLACK_ENUM.name = "eft_black"
E_FLOWER_TYPE_EFT_BLACK_ENUM.index = 0
E_FLOWER_TYPE_EFT_BLACK_ENUM.number = 0
E_FLOWER_TYPE_EFT_RED_ENUM.name = "eft_red"
E_FLOWER_TYPE_EFT_RED_ENUM.index = 1
E_FLOWER_TYPE_EFT_RED_ENUM.number = 1
E_FLOWER_TYPE_EFT_PLUM_ENUM.name = "eft_plum"
E_FLOWER_TYPE_EFT_PLUM_ENUM.index = 2
E_FLOWER_TYPE_EFT_PLUM_ENUM.number = 2
E_FLOWER_TYPE_EFT_BLOCK_ENUM.name = "eft_block"
E_FLOWER_TYPE_EFT_BLOCK_ENUM.index = 3
E_FLOWER_TYPE_EFT_BLOCK_ENUM.number = 3
E_FLOWER_TYPE.name = "e_flower_type"
E_FLOWER_TYPE.full_name = ".game_multitexas_protocols.e_flower_type"
E_FLOWER_TYPE.values = {E_FLOWER_TYPE_EFT_BLACK_ENUM,E_FLOWER_TYPE_EFT_RED_ENUM,E_FLOWER_TYPE_EFT_PLUM_ENUM,E_FLOWER_TYPE_EFT_BLOCK_ENUM}
E_CARD_TYPE_ECT_UNKNOW_ENUM.name = "ect_unknow"
E_CARD_TYPE_ECT_UNKNOW_ENUM.index = 0
E_CARD_TYPE_ECT_UNKNOW_ENUM.number = 0
E_CARD_TYPE_ECT_HIGH_CARD_ENUM.name = "ect_high_card"
E_CARD_TYPE_ECT_HIGH_CARD_ENUM.index = 1
E_CARD_TYPE_ECT_HIGH_CARD_ENUM.number = 1
E_CARD_TYPE_ECT_ONE_PAIR_ENUM.name = "ect_one_pair"
E_CARD_TYPE_ECT_ONE_PAIR_ENUM.index = 2
E_CARD_TYPE_ECT_ONE_PAIR_ENUM.number = 2
E_CARD_TYPE_ECT_TWO_PAIRS_ENUM.name = "ect_two_pairs"
E_CARD_TYPE_ECT_TWO_PAIRS_ENUM.index = 3
E_CARD_TYPE_ECT_TWO_PAIRS_ENUM.number = 3
E_CARD_TYPE_ECT_THREE_OF_A_KIND_ENUM.name = "ect_three_of_a_kind"
E_CARD_TYPE_ECT_THREE_OF_A_KIND_ENUM.index = 4
E_CARD_TYPE_ECT_THREE_OF_A_KIND_ENUM.number = 4
E_CARD_TYPE_ECT_STRAIGHT_ENUM.name = "ect_straight"
E_CARD_TYPE_ECT_STRAIGHT_ENUM.index = 5
E_CARD_TYPE_ECT_STRAIGHT_ENUM.number = 5
E_CARD_TYPE_ECT_FLUSH_ENUM.name = "ect_flush"
E_CARD_TYPE_ECT_FLUSH_ENUM.index = 6
E_CARD_TYPE_ECT_FLUSH_ENUM.number = 6
E_CARD_TYPE_ECT_THREE_ADD_TWO_ENUM.name = "ect_three_add_two"
E_CARD_TYPE_ECT_THREE_ADD_TWO_ENUM.index = 7
E_CARD_TYPE_ECT_THREE_ADD_TWO_ENUM.number = 7
E_CARD_TYPE_ECT_FOUR_OF_A_KIND_ENUM.name = "ect_four_of_a_kind"
E_CARD_TYPE_ECT_FOUR_OF_A_KIND_ENUM.index = 8
E_CARD_TYPE_ECT_FOUR_OF_A_KIND_ENUM.number = 8
E_CARD_TYPE_ECT_STRAIGHT_FLUSH_ENUM.name = "ect_straight_flush"
E_CARD_TYPE_ECT_STRAIGHT_FLUSH_ENUM.index = 9
E_CARD_TYPE_ECT_STRAIGHT_FLUSH_ENUM.number = 9
E_CARD_TYPE_ECT_ROYAL_FLUSH_ENUM.name = "ect_royal_flush"
E_CARD_TYPE_ECT_ROYAL_FLUSH_ENUM.index = 10
E_CARD_TYPE_ECT_ROYAL_FLUSH_ENUM.number = 10
E_CARD_TYPE.name = "e_card_type"
E_CARD_TYPE.full_name = ".game_multitexas_protocols.e_card_type"
E_CARD_TYPE.values = {E_CARD_TYPE_ECT_UNKNOW_ENUM,E_CARD_TYPE_ECT_HIGH_CARD_ENUM,E_CARD_TYPE_ECT_ONE_PAIR_ENUM,E_CARD_TYPE_ECT_TWO_PAIRS_ENUM,E_CARD_TYPE_ECT_THREE_OF_A_KIND_ENUM,E_CARD_TYPE_ECT_STRAIGHT_ENUM,E_CARD_TYPE_ECT_FLUSH_ENUM,E_CARD_TYPE_ECT_THREE_ADD_TWO_ENUM,E_CARD_TYPE_ECT_FOUR_OF_A_KIND_ENUM,E_CARD_TYPE_ECT_STRAIGHT_FLUSH_ENUM,E_CARD_TYPE_ECT_ROYAL_FLUSH_ENUM}
...
e_mst_c2l_leave_list_banker = 10017
...
e_state_game_bet = 1
ect_flush = 6
ect_four_of_a_kind = 8
ect_high_card = 1
ect_one_pair = 2
ect_royal_flush = 10
ect_straight = 5
ect_straight_flush = 9
ect_three_add_two = 7
ect_three_of_a_kind = 4
ect_two_pairs = 3
ect_unknow = 0
eft_black = 0
eft_block = 3
