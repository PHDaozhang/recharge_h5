...
E_SERVER_MSG_TYPE.full_name = ".game_baccarat_protocols.e_server_msg_type"
...
E_GAME_STATE.full_name = ".game_baccarat_protocols.e_game_state"
...
E_CARD_FLOWER.full_name = ".game_baccarat_protocols.e_card_flower"
