...
class packetw2c_notice : public ::google::protobuf::Message {
 public:
  packetw2c_notice();
  virtual ~packetw2c_notice();

  packetw2c_notice(const packetw2c_notice& from);

  inline packetw2c_notice& operator=(const packetw2c_notice& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const packetw2c_notice& default_instance();

  void Swap(packetw2c_notice* other);

  // implements Message ----------------------------------------------

  packetw2c_notice* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const packetw2c_notice& from);
  void MergeFrom(const packetw2c_notice& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:client2world_protocols.packetw2c_notice)
 private:
  inline void set_has_packet_id();
  inline void clear_has_packet_id();
  ...
  void InitAsDefaultInstance();
  static packetw2c_notice* default_instance_;
};
// ===================================================================
...
// optional .client2world_protocols.e_server_msg_type packet_id = 1 [default = e_mst_w2c_notice];
inline bool packetw2c_notice::has_packet_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void packetw2c_notice::set_has_packet_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void packetw2c_notice::clear_has_packet_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void packetw2c_notice::clear_packet_id() {
  packet_id_ = 7644;
  clear_has_packet_id();
}
inline ::client2world_protocols::e_server_msg_type packetw2c_notice::packet_id() const {
  return static_cast< ::client2world_protocols::e_server_msg_type >(packet_id_);
}
inline void packetw2c_notice::set_packet_id(::client2world_protocols::e_server_msg_type value) {
  assert(::client2world_protocols::e_server_msg_type_IsValid(value));
  set_has_packet_id();
  packet_id_ = value;
}
