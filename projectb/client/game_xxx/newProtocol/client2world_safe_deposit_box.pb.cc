...
void protobuf_AssignDesc_client2world_5fsafe_5fdeposit_5fbox_2eproto() {
  ...
  static const int packetc2w_check_password_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(packetc2w_check_password, npwd_),
  };
...
void protobuf_AddDesc_client2world_5fsafe_5fdeposit_5fbox_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ult\022\016\n\006result\030\002 \001(\005\"\215\001\n\030packetc2w_check_"
    "password\022V\n\tpacket_id\030\001 \001(\0162).client2wor"
    "ld_protocols.e_server_msg_type:\030e_mst_c2"
    "w_check_password\022\013\n\003pwd\030\002 \001(\t\022\014\n\004npwd\030\004 "
    "\001(\t\"\220\001\n\037packetw2c_check_password_result\022"
    "]\n\tpacket_id\030\001 \001(\0162).client2world_protoc"
    "ols.e_server_msg_type:\037e_mst_w2c_check_p"
    "assword_result\022\016\n\006result\030\002 \001(\005", 2230);
...
const int packetc2w_check_password::kNpwdFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(34)) goto parse_npwd;
        break;
      }
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_npwd:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_npwd()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->npwd().data(), this->npwd().length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
