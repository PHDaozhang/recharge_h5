...
#ifndef PROTOBUF_game_5fttz_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fttz_5fdef_2eproto__INCLUDED
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_ttz_protocols::e_server_msg_type>() {
  return ::game_ttz_protocols::e_server_msg_type_descriptor();
}
...
#endif  // PROTOBUF_game_5fttz_5fdef_2eproto__INCLUDED
