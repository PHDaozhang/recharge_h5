...
#ifndef PROTOBUF_game_5fbaccarat_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fbaccarat_5fdef_2eproto__INCLUDED
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_baccarat_protocols::e_server_msg_type>() {
  return ::game_baccarat_protocols::e_server_msg_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_baccarat_protocols::e_game_state>() {
  return ::game_baccarat_protocols::e_game_state_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_baccarat_protocols::e_card_flower>() {
  return ::game_baccarat_protocols::e_card_flower_descriptor();
}
...
#endif  // PROTOBUF_game_5fbaccarat_5fdef_2eproto__INCLUDED
