...
class msg_account_info : public ::google::protobuf::Message {
 public:
  ...
  static const int kPerformanceFieldNumber = 62;
  inline ::google::protobuf::int64 performance() const;
  inline void set_performance(::google::protobuf::int64 value);
 ...
 private:
  ...
  ::google::protobuf::int64 performance_;
...
// optional int64 performance = 62;
inline bool msg_account_info::has_performance() const {
  return (_has_bits_[1] & 0x00000001u) != 0;
}
inline void msg_account_info::set_has_performance() {
  _has_bits_[1] |= 0x00000001u;
}
inline void msg_account_info::clear_has_performance() {
  _has_bits_[1] &= ~0x00000001u;
}
inline void msg_account_info::clear_performance() {
  performance_ = GOOGLE_LONGLONG(0);
  clear_has_performance();
}
inline ::google::protobuf::int64 msg_account_info::performance() const {
  return performance_;
}
inline void msg_account_info::set_performance(::google::protobuf::int64 value) {
  set_has_performance();
  performance_ = value;
}
