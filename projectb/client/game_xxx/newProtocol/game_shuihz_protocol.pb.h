...
class packetl2c_player_change_money : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_bonus_state() const;
  inline void clear_bonus_state();
  static const int kBonusStateFieldNumber = 5;
  inline ::google::protobuf::int32 bonus_state() const;
  inline void set_bonus_state(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_bonus_state();
  inline void clear_has_bonus_state();
  ...
  ::google::protobuf::int32 bonus_state_;
...
// optional int32 bonus_state = 5;
inline bool packetl2c_player_change_money::has_bonus_state() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void packetl2c_player_change_money::set_has_bonus_state() {
  _has_bits_[0] |= 0x00000010u;
}
inline void packetl2c_player_change_money::clear_has_bonus_state() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void packetl2c_player_change_money::clear_bonus_state() {
  bonus_state_ = 0;
  clear_has_bonus_state();
}
inline ::google::protobuf::int32 packetl2c_player_change_money::bonus_state() const {
  return bonus_state_;
}
inline void packetl2c_player_change_money::set_bonus_state(::google::protobuf::int32 value) {
  set_has_bonus_state();
  bonus_state_ = value;
}
