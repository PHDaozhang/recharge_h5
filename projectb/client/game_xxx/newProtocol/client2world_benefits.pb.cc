...
const ::google::protobuf::Descriptor* packet_w2c_update_ipinfo_result_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  packet_w2c_update_ipinfo_result_reflection_ = NULL;
...
void protobuf_AssignDesc_client2world_5fbenefits_2eproto() {
  ...
  packet_w2c_update_ipinfo_result_descriptor_ = file->message_type(2);
  static const int packet_w2c_update_ipinfo_result_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(packet_w2c_update_ipinfo_result, packet_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(packet_w2c_update_ipinfo_result, ipinfo_),
  };
  packet_w2c_update_ipinfo_result_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      packet_w2c_update_ipinfo_result_descriptor_,
      packet_w2c_update_ipinfo_result::default_instance_,
      packet_w2c_update_ipinfo_result_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(packet_w2c_update_ipinfo_result, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(packet_w2c_update_ipinfo_result, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(packet_w2c_update_ipinfo_result));
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    packet_w2c_update_ipinfo_result_descriptor_, &packet_w2c_update_ipinfo_result::default_instance());
}
...
void protobuf_ShutdownFile_client2world_5fbenefits_2eproto() {
  ...
  delete packet_w2c_update_ipinfo_result::default_instance_;
  delete packet_w2c_update_ipinfo_result_reflection_;
}
...
void protobuf_AddDesc_client2world_5fbenefits_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "mt_fail\"\217\001\n\037packet_w2c_update_ipinfo_res"
    "ult\022\\\n\tpacket_id\030\001 \001(\0162).client2world_pr"
    "otocols.e_server_msg_type:\036e_mst_w2c_upd"
    "ate_ipinfo_result\022\016\n\006ipinfo\030\002 \001(\t", 553);
  ...
  packet_w2c_update_ipinfo_result::default_instance_ = new packet_w2c_update_ipinfo_result();
  ...
  packet_w2c_update_ipinfo_result::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int packet_w2c_update_ipinfo_result::kPacketIdFieldNumber;
const int packet_w2c_update_ipinfo_result::kIpinfoFieldNumber;
#endif  // !_MSC_VER

packet_w2c_update_ipinfo_result::packet_w2c_update_ipinfo_result()
  : ::google::protobuf::Message() {
  SharedCtor();
}

void packet_w2c_update_ipinfo_result::InitAsDefaultInstance() {
}

packet_w2c_update_ipinfo_result::packet_w2c_update_ipinfo_result(const packet_w2c_update_ipinfo_result& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void packet_w2c_update_ipinfo_result::SharedCtor() {
  _cached_size_ = 0;
  packet_id_ = 7621;
...
void packet_w2c_update_ipinfo_result::SharedDtor() {
...
void packet_w2c_update_ipinfo_result::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* packet_w2c_update_ipinfo_result::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return packet_w2c_update_ipinfo_result_descriptor_;
}

const packet_w2c_update_ipinfo_result& packet_w2c_update_ipinfo_result::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_client2world_5fbenefits_2eproto();
  return *default_instance_;
}

packet_w2c_update_ipinfo_result* packet_w2c_update_ipinfo_result::default_instance_ = NULL;

packet_w2c_update_ipinfo_result* packet_w2c_update_ipinfo_result::New() const {
  return new packet_w2c_update_ipinfo_result;
}

void packet_w2c_update_ipinfo_result::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    packet_id_ = 7621;
    if (has_ipinfo()) {
      if (ipinfo_ != &::google::protobuf::internal::kEmptyString) {
...
bool packet_w2c_update_ipinfo_result::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .client2world_protocols.e_server_msg_type packet_id = 1 [default = e_mst_w2c_update_ipinfo_result];
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
          int value;
        ...
        if (input->ExpectTag(18)) goto parse_ipinfo;
        break;
      }

      // optional string ipinfo = 2;
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
...
void packet_w2c_update_ipinfo_result::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // optional .client2world_protocols.e_server_msg_type packet_id = 1 [default = e_mst_w2c_update_ipinfo_result];
  if (has_packet_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteEnum(
...
::google::protobuf::uint8* packet_w2c_update_ipinfo_result::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // optional .client2world_protocols.e_server_msg_type packet_id = 1 [default = e_mst_w2c_update_ipinfo_result];
  if (has_packet_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteEnumToArray(
...
int packet_w2c_update_ipinfo_result::ByteSize() const {
  int total_size = 0;
...
void packet_w2c_update_ipinfo_result::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const packet_w2c_update_ipinfo_result* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const packet_w2c_update_ipinfo_result*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void packet_w2c_update_ipinfo_result::MergeFrom(const packet_w2c_update_ipinfo_result& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_packet_id()) {
      set_packet_id(from.packet_id());
...
void packet_w2c_update_ipinfo_result::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void packet_w2c_update_ipinfo_result::CopyFrom(const packet_w2c_update_ipinfo_result& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool packet_w2c_update_ipinfo_result::IsInitialized() const {

  return true;
}

void packet_w2c_update_ipinfo_result::Swap(packet_w2c_update_ipinfo_result* other) {
  if (other != this) {
    std::swap(packet_id_, other->packet_id_);
...
::google::protobuf::Metadata packet_w2c_update_ipinfo_result::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = packet_w2c_update_ipinfo_result_descriptor_;
  metadata.reflection = packet_w2c_update_ipinfo_result_reflection_;
  return metadata;
}
