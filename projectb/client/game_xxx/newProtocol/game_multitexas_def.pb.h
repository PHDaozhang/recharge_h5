...
#ifndef PROTOBUF_game_5fmultitexas_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fmultitexas_5fdef_2eproto__INCLUDED
...
const e_flower_type e_flower_type_MIN = eft_black;
const e_flower_type e_flower_type_MAX = eft_block;
const int e_flower_type_ARRAYSIZE = e_flower_type_MAX + 1;

const ::google::protobuf::EnumDescriptor* e_flower_type_descriptor();
inline const ::std::string& e_flower_type_Name(e_flower_type value) {
  return ::google::protobuf::internal::NameOfEnum(
    e_flower_type_descriptor(), value);
}
inline bool e_flower_type_Parse(
    const ::std::string& name, e_flower_type* value) {
  return ::google::protobuf::internal::ParseNamedEnum<e_flower_type>(
    e_flower_type_descriptor(), name, value);
}
enum e_card_type {
  ect_unknow = 0,
  ect_high_card = 1,
...
const e_card_type e_card_type_MIN = ect_unknow;
const e_card_type e_card_type_MAX = ect_royal_flush;
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_multitexas_protocols::e_server_msg_type>() {
  return ::game_multitexas_protocols::e_server_msg_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_multitexas_protocols::e_game_state>() {
  return ::game_multitexas_protocols::e_game_state_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_multitexas_protocols::e_flower_type>() {
  return ::game_multitexas_protocols::e_flower_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_multitexas_protocols::e_card_type>() {
  return ::game_multitexas_protocols::e_card_type_descriptor();
}
...
#endif  // PROTOBUF_game_5fmultitexas_5fdef_2eproto__INCLUDED
