...
class packetl2c_get_room_scene_info_result : public ::google::protobuf::Message {
 public:
  ...
  inline const ::game_fruits_protocols::msg_betinfo& bet_info_list(int index) const;
  inline ::game_fruits_protocols::msg_betinfo* mutable_bet_info_list(int index);
  inline ::game_fruits_protocols::msg_betinfo* add_bet_info_list();
  inline const ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_betinfo >&
      bet_info_list() const;
  inline ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_betinfo >*
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_betinfo > bet_info_list_;
...
class msg_master_bets : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:game_fruits_protocols.msg_master_bets)
 private:
  inline void set_has_player_id();
  inline void clear_has_player_id();
...
class msg_betinfo : public ::google::protobuf::Message {
 public:
  ...
  inline const ::game_fruits_protocols::msg_master_bets& master_bets(int index) const;
  inline ::game_fruits_protocols::msg_master_bets* mutable_master_bets(int index);
  inline ::game_fruits_protocols::msg_master_bets* add_master_bets();
  inline const ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_master_bets >&
      master_bets() const;
  inline ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_master_bets >*
      mutable_master_bets();

  // @@protoc_insertion_point(class_scope:game_fruits_protocols.msg_betinfo)
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_master_bets > master_bets_;
...
class packetl2c_bc_sync_bets : public ::google::protobuf::Message {
 public:
  ...
  inline const ::game_fruits_protocols::msg_betinfo& bets(int index) const;
  inline ::game_fruits_protocols::msg_betinfo* mutable_bets(int index);
  inline ::game_fruits_protocols::msg_betinfo* add_bets();
  inline const ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_betinfo >&
      bets() const;
  inline ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_betinfo >*
      mutable_bets();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_betinfo > bets_;
  int packet_id_;
...
class packetc2l_ask_playerlist : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:game_fruits_protocols.packetc2l_ask_playerlist)
 private:
  inline void set_has_packet_id();
  inline void clear_has_packet_id();
...
class packetl2c_playerlist_result : public ::google::protobuf::Message {
 public:
  ...
  inline const ::game_fruits_protocols::player_info& player_infos(int index) const;
  inline ::game_fruits_protocols::player_info* mutable_player_infos(int index);
  inline ::game_fruits_protocols::player_info* add_player_infos();
  inline const ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::player_info >&
      player_infos() const;
  inline ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::player_info >*
      mutable_player_infos();

  // @@protoc_insertion_point(class_scope:game_fruits_protocols.packetl2c_playerlist_result)
 private:
  inline void set_has_packet_id();
  inline void clear_has_packet_id();
  ...
  ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::player_info > player_infos_;
  int packet_id_;
...
inline const ::game_fruits_protocols::msg_betinfo& packetl2c_get_room_scene_info_result::bet_info_list(int index) const {
  return bet_info_list_.Get(index);
}
inline ::game_fruits_protocols::msg_betinfo* packetl2c_get_room_scene_info_result::mutable_bet_info_list(int index) {
  return bet_info_list_.Mutable(index);
}
inline ::game_fruits_protocols::msg_betinfo* packetl2c_get_room_scene_info_result::add_bet_info_list() {
...
inline const ::game_fruits_protocols::msg_master_bets& msg_betinfo::master_bets(int index) const {
  return master_bets_.Get(index);
}
inline ::game_fruits_protocols::msg_master_bets* msg_betinfo::mutable_master_bets(int index) {
  return master_bets_.Mutable(index);
}
inline ::game_fruits_protocols::msg_master_bets* msg_betinfo::add_master_bets() {
...
// repeated .game_fruits_protocols.msg_betinfo bets = 2;
inline int packetl2c_bc_sync_bets::bets_size() const {
  return bets_.size();
}
inline void packetl2c_bc_sync_bets::clear_bets() {
  bets_.Clear();
}
inline const ::game_fruits_protocols::msg_betinfo& packetl2c_bc_sync_bets::bets(int index) const {
  return bets_.Get(index);
}
inline ::game_fruits_protocols::msg_betinfo* packetl2c_bc_sync_bets::mutable_bets(int index) {
  return bets_.Mutable(index);
}
inline ::game_fruits_protocols::msg_betinfo* packetl2c_bc_sync_bets::add_bets() {
  return bets_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_betinfo >&
packetl2c_bc_sync_bets::bets() const {
  return bets_;
}
inline ::google::protobuf::RepeatedPtrField< ::game_fruits_protocols::msg_betinfo >*
packetl2c_bc_sync_bets::mutable_bets() {
  return &bets_;
}
...
inline ::game_fruits_protocols::e_server_msg_type packetc2l_ask_playerlist::packet_id() const {
  return static_cast< ::game_fruits_protocols::e_server_msg_type >(packet_id_);
}
inline void packetc2l_ask_playerlist::set_packet_id(::game_fruits_protocols::e_server_msg_type value) {
  assert(::game_fruits_protocols::e_server_msg_type_IsValid(value));
  set_has_packet_id();
  packet_id_ = value;
}
...
inline ::game_fruits_protocols::e_server_msg_type packetl2c_playerlist_result::packet_id() const {
  return static_cast< ::game_fruits_protocols::e_server_msg_type >(packet_id_);
}
inline void packetl2c_playerlist_result::set_packet_id(::game_fruits_protocols::e_server_msg_type value) {
  assert(::game_fruits_protocols::e_server_msg_type_IsValid(value));
  set_has_packet_id();
  packet_id_ = value;
}
...
inline const ::game_fruits_protocols::player_info& packetl2c_playerlist_result::player_infos(int index) const {
  return player_infos_.Get(index);
}
inline ::game_fruits_protocols::player_info* packetl2c_playerlist_result::mutable_player_infos(int index) {
  return player_infos_.Mutable(index);
}
inline ::game_fruits_protocols::player_info* packetl2c_playerlist_result::add_player_infos() {
