...
#ifndef PROTOBUF_game_5fernn_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fernn_5fdef_2eproto__INCLUDED
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_ernn_protocols::e_server_msg_type>() {
  return ::game_ernn_protocols::e_server_msg_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_ernn_protocols::e_notify_type>() {
  return ::game_ernn_protocols::e_notify_type_descriptor();
}
...
#endif  // PROTOBUF_game_5fernn_5fdef_2eproto__INCLUDED
