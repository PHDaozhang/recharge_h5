...
const e_game_state e_game_state_MAX = e_state_game_check;
...
class msg_player_info : public ::google::protobuf::Message {
 public:
  ...
  static const int kIsRobFieldNumber = 7;
  ...
  static const int kIsLeftFieldNumber = 10;
...
// optional bool is_rob = 7;
inline bool msg_player_info::has_is_rob() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void msg_player_info::set_has_is_rob() {
  _has_bits_[0] |= 0x00000040u;
}
inline void msg_player_info::clear_has_is_rob() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void msg_player_info::clear_is_rob() {
  is_rob_ = false;
  clear_has_is_rob();
}
inline bool msg_player_info::is_rob() const {
  return is_rob_;
}
inline void msg_player_info::set_is_rob(bool value) {
  set_has_is_rob();
  is_rob_ = value;
}
