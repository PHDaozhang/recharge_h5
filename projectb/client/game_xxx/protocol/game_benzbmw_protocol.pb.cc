...
void protobuf_AddDesc_game_5fbenzbmw_5fprotocol_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "info_list\030\005 \003(\005\022\024\n\014history_list\030\006 \003(\005\0228\n"
    "\013banker_info\030\007 \001(\0132#.game_benzbmw_protoc"
    "ols.player_info\022\031\n\021is_can_rob_banker\030\010 \001"
    "(\010\022\026\n\016continue_count\030\t \001(\005\022\025\n\rself_bet_l"
    "ist\030\n \003(\005\"j\n\024packetc2l_leave_room\022R\n\tpac"
    "ket_id\030\001 \001(\0162).game_benzbmw_protocols.e_"
    "server_msg_type:\024e_mst_c2l_leave_room\"\267\001"
    "\n\033packetl2c_leave_room_result\022Y\n\tpacket_"
    ...
    "_banker\022V\n\tpacket_id\030\001 \001(\0162).game_benzbm"
    "w_protocols.e_server_msg_type:\030e_mst_c2l"
    "_ask_for_banker\"\270\001\n\037packetl2c_ask_for_ba"
    "nker_result\022V\n\tpacket_id\030\001 \001(\0162).game_be"
    "nzbmw_protocols.e_server_msg_type:\030e_mst"
    "_l2c_ask_for_banker\022=\n\006result\030\002 \001(\0162\036.ms"
    "g_type_def.e_msg_result_def:\re_rmt_succe"
    "ss\"n\n\026packetc2l_leave_banker\022T\n\tpacket_i"
    "d\030\001 \001(\0162).game_benzbmw_protocols.e_serve"
    "r_msg_type:\026e_mst_c2l_leave_banker\"\264\001\n\035p"
    "acketl2c_leave_banker_result\022T\n\tpacket_i"
    "d\030\001 \001(\0162).game_benzbmw_protocols.e_serve"
    "r_msg_type:\026e_mst_l2c_leave_banker\022=\n\006re"
    "sult\030\002 \001(\0162\036.msg_type_def.e_msg_result_d"
    "ef:\re_rmt_success\"~\n\036packetc2l_ask_for_f"
    "irst_banker\022\\\n\tpacket_id\030\001 \001(\0162).game_be"
    "nzbmw_protocols.e_server_msg_type:\036e_mst"
    "_c2l_ask_first_for_banker\"\304\001\n%packetl2c_"
    "ask_for_first_banker_result\022\\\n\tpacket_id"
    "\030\001 \001(\0162).game_benzbmw_protocols.e_server"
    "_msg_type:\036e_mst_l2c_ask_first_for_banke"
    "r\022=\n\006result\030\002 \001(\0162\036.msg_type_def.e_msg_r"
    "esult_def:\re_rmt_success\"\260\001\n\013player_info"
    "\022\021\n\tplayer_id\030\001 \001(\005\022\027\n\017player_nickname\030\002"
    " \001(\t\022\031\n\021player_head_frame\030\003 \001(\005\022\032\n\022playe"
    "r_head_custom\030\004 \001(\t\022\023\n\013player_gold\030\005 \001(\005"
    "\022\022\n\nplayer_sex\030\006 \001(\005\022\025\n\rplayer_vip_lv\030\007 "
    "\001(\005\"x\n\035packetc2l_ask_for_player_list\022W\n\t"
    "packet_id\030\001 \001(\0162).game_benzbmw_protocols"
    ".e_server_msg_type:\031e_mst_c2l_ask_player"
    "_list\"\271\001\n$packetl2c_ask_for_player_list_"
    "result\022W\n\tpacket_id\030\001 \001(\0162).game_benzbmw"
    "_protocols.e_server_msg_type:\031e_mst_l2c_"
    "ask_player_list\0228\n\013player_list\030\002 \003(\0132#.g"
    "ame_benzbmw_protocols.player_info\"x\n\035pac"
    "ketc2l_ask_for_banker_list\022W\n\tpacket_id\030"
    "\001 \001(\0162).game_benzbmw_protocols.e_server_"
    "msg_type:\031e_mst_c2l_ask_banker_list\"\271\001\n$"
    "packetl2c_ask_for_banker_list_result\022W\n\t"
    "packet_id\030\001 \001(\0162).game_benzbmw_protocols"
    ".e_server_msg_type:\031e_mst_l2c_ask_banker"
    "_list\0228\n\013banker_list\030\002 \003(\0132#.game_benzbm"
    "w_protocols.player_info\"z\n\036packetc2l_ask"
    "_for_history_list\022X\n\tpacket_id\030\001 \001(\0162).g"
    "ame_benzbmw_protocols.e_server_msg_type:"
    "\032e_mst_c2l_ask_history_list\"\227\001\n%packetl2"
    "c_ask_for_history_list_result\022X\n\tpacket_"
    "id\030\001 \001(\0162).game_benzbmw_protocols.e_serv"
    "er_msg_type:\032e_mst_l2c_ask_history_list\022"
    "\024\n\014history_list\030\002 \003(\005\"\232\001\n\026packetl2c_bc_b"
    "egin_bet\022T\n\tpacket_id\030\001 \001(\0162).game_benzb"
    "mw_protocols.e_server_msg_type:\026e_mst_l2"
    "c_bc_begin_bet\022\017\n\007cd_time\030\002 \001(\005\022\031\n\021is_ca"
    "n_rob_banker\030\003 \001(\010\"r\n\020PlayerIncomeInfo\022<"
    "\n\017player_baseInfo\030\001 \001(\0132#.game_benzbmw_p"
    "rotocols.player_info\022\020\n\010betCount\030\002 \001(\005\022\016"
    "\n\006income\030\003 \001(\005\"\364\001\n\030packetl2c_bc_begin_aw"
    "ard\022V\n\tpacket_id\030\001 \001(\0162).game_benzbmw_pr"
    ...
    "yerIncomeList\030\005 \003(\0132(.game_benzbmw_proto"
    "cols.PlayerIncomeInfo\"\217\001\n\033packetl2c_bc_t"
    "otal_bet_info\022Y\n\tpacket_id\030\001 \001(\0162).game_"
    "benzbmw_protocols.e_server_msg_type:\033e_m"
    "st_l2c_bc_total_bet_info\022\025\n\rbet_info_lis"
    "t\030\002 \003(\005\"\240\001\n\034packetl2c_bc_rob_banker_info"
    "\022Z\n\tpacket_id\030\001 \001(\0162).game_benzbmw_proto"
    "cols.e_server_msg_type:\034e_mst_l2c_bc_rob"
    "_banker_info\022\021\n\tplayer_id\030\002 \001(\005\022\021\n\tpay_c"
    "ount\030\003 \001(\005\"\362\001\n\032packetl2c_bc_change_banke"
    "r\022X\n\tpacket_id\030\001 \001(\0162).game_benzbmw_prot"
    "ocols.e_server_msg_type:\032e_mst_l2c_bc_ch"
    "ange_banker\0228\n\013banker_info\030\002 \001(\0132#.game_"
    "benzbmw_protocols.player_info\022\016\n\006is_rob\030"
    "\003 \001(\010\022\025\n\rold_banker_id\030\004 \001(\005\022\031\n\021system_d"
    "raw_water\030\005 \001(\005\"\226\001\n\030packetl2c_bc_accept_"
    "gift\022V\n\tpacket_id\030\001 \001(\0162).game_benzbmw_p"
    "rotocols.e_server_msg_type:\030e_mst_l2c_bc"
    "_accept_gift\022\021\n\tplayer_id\030\002 \001(\005\022\017\n\007gift_"
    "id\030\003 \001(\005\"j\n\014packetc2l_gm\022J\n\tpacket_id\030\001 "
    "\001(\0162).game_benzbmw_protocols.e_server_ms"
    "g_type:\014e_mst_c2l_gm\022\016\n\006gm_max\030\002 \001(\005\"d\n\021"
    "user_meg_bet_info\0228\n\013player_info\030\001 \001(\0132#"
    ".game_benzbmw_protocols.player_info\022\025\n\rb"
    "et_info_list\030\002 \003(\005\"\273\001\n\033packetl2c_bc_ever"
    "y_bet_info\022Y\n\tpacket_id\030\001 \001(\0162).game_ben"
    "zbmw_protocols.e_server_msg_type:\033e_mst_"
    "l2c_bc_every_bet_info\022A\n\016user_info_list\030"
    "\002 \003(\0132).game_benzbmw_protocols.user_meg_"
    "bet_info\"\221\001\n\037packetc2l_control_change_re"
    "sult\022]\n\tpacket_id\030\001 \001(\0162).game_benzbmw_p"
    "rotocols.e_server_msg_type:\037e_mst_c2l_co"
    "ntrol_change_result\022\017\n\007command\030\002 \001(\005\"\277\001\n"
    "\037packetl2c_control_change_result\022]\n\tpack"
    "et_id\030\001 \001(\0162).game_benzbmw_protocols.e_s"
    "erver_msg_type:\037e_mst_l2c_control_change"
    "_result\022=\n\006result\030\002 \001(\0162\036.msg_type_def.e"
    "_msg_result_def:\re_rmt_success\"\336\001\n\026packe"
    "tl2c_bc_debuginfo\022T\n\tpacket_id\030\001 \001(\0162).g"
    "ame_benzbmw_protocols.e_server_msg_type:"
    "\026e_mst_l2c_bc_debuginfo\022\021\n\tplayer_id\030\002 \001"
    "(\005\022\027\n\014total_profit\030\003 \001(\003:\0010\022\026\n\013total_sto"
    "ck\030\004 \001(\003:\0010\022\025\n\ntotal_Rate\030\006 \001(\003:\0010\022\023\n\013de"
    "bug_infos\030\005 \001(\t\"\301\001\n\032packetl2c_notice_ban"
    "k_info\022[\n\tpacket_id\030\001 \001(\0162).game_benzbmw"
    "_protocols.e_server_msg_type:\035e_mst_l2c_"
    "notice_gm_bank_info\0228\n\013player_info\030\002 \001(\013"
    "2#.game_benzbmw_protocols.player_info\022\014\n"
    "\004type\030\003 \001(\005", 7131);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .game_benzbmw_protocols.e_server_msg_type packet_id = 1 [default = e_mst_l2c_bc_accept_gift];
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
          int value;
