...
#ifndef PROTOBUF_game_5fhundredniuniu_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fhundredniuniu_5fdef_2eproto__INCLUDED
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_Hundredniuniu_protocols::e_server_msg_type>() {
  return ::game_Hundredniuniu_protocols::e_server_msg_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_Hundredniuniu_protocols::e_game_state>() {
  return ::game_Hundredniuniu_protocols::e_game_state_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_Hundredniuniu_protocols::e_card_flower>() {
  return ::game_Hundredniuniu_protocols::e_card_flower_descriptor();
}
...
#endif  // PROTOBUF_game_5fhundredniuniu_5fdef_2eproto__INCLUDED
