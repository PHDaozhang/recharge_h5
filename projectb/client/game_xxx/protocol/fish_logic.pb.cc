...
void protobuf_AddDesc_fish_5flogic_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "scene_info\"\213\001\n\025packetc2l_change_seat\022K\n\t"
    "packet_id\030\001 \001(\0162!.fish_protocols.e_serve"
    "r_msg_type:\025e_mst_c2l_change_seat\022\021\n\tpla"
    "yer_id\030\002 \001(\005\022\022\n\nseat_index\030\003 \001(\005\"y\n\025pack"
    "etc2l_change_rate\022K\n\tpacket_id\030\001 \001(\0162!.f"
    "ish_protocols.e_server_msg_type:\025e_mst_c"
    "2l_change_rate\022\023\n\013turret_rate\030\002 \001(\005\"\256\001\n\034"
    "packetl2c_change_seat_result\022R\n\tpacket_i"
    "d\030\001 \001(\0162!.fish_protocols.e_server_msg_ty"
    "pe:\034e_mst_l2c_change_seat_result\022:\n\006resu"
    "lt\030\002 \001(\0162\036.msg_type_def.e_msg_result_def"
    ":\ne_rmt_fail\"\300\001\n\034packetl2c_change_rate_r"
    "esult\022R\n\tpacket_id\030\001 \001(\0162!.fish_protocol"
    "s.e_server_msg_type:\034e_mst_l2c_change_ra"
    "te_result\022:\n\006result\030\002 \001(\0162\036.msg_type_def"
    ".e_msg_result_def:\ne_rmt_fail\022\020\n\010old_rat"
    "e\030\003 \001(\005\"b\n\024packetc2l_try_turret\022J\n\tpacke"
    "t_id\030\001 \001(\0162!.fish_protocols.e_server_msg"
    "_type:\024e_mst_c2l_try_turret\"\334\001\n\033packetl2"
    "c_try_turret_result\022Q\n\tpacket_id\030\001 \001(\0162!"
    ".fish_protocols.e_server_msg_type:\033e_mst"
    "_l2c_try_turret_result\022:\n\006result\030\002 \001(\0162\036"
    ".msg_type_def.e_msg_result_def:\ne_rmt_fa"
    "il\022\031\n\rtry_turret_id\030\003 \001(\005:\002-1\022\023\n\013try_end"
    "time\030\004 \001(\005\"n\n\032packetc2l_try_turret_state"
    "\022P\n\tpacket_id\030\001 \001(\0162!.fish_protocols.e_s"
    "erver_msg_type:\032e_mst_c2l_try_turret_sta"
    "te\"\320\001\n!packetl2c_try_turret_state_result"
    "\022W\n\tpacket_id\030\001 \001(\0162!.fish_protocols.e_s"
    "erver_msg_type:!e_mst_l2c_try_turret_sta"
    "te_result\022\031\n\rtry_turret_id\030\002 \001(\005:\002-1\022\022\n\n"
    "fire_count\030\003 \001(\005\022\016\n\006try_cd\030\004 \001(\005\022\023\n\013try_"
    "endtime\030\005 \001(\005\"\205\001\n\032packetc2l_use_turret_p"
    "ower\022P\n\tpacket_id\030\001 \001(\0162!.fish_protocols"
    ".e_server_msg_type:\032e_mst_c2l_use_turret"
    "_power\022\025\n\006is_buy\030\002 \001(\010:\005false\"\343\001\n!packet"
    "l2c_use_turret_power_result\022W\n\tpacket_id"
    "\030\001 \001(\0162!.fish_protocols.e_server_msg_typ"
    "e:!e_mst_l2c_use_turret_power_result\022:\n\006"
    "result\030\002 \001(\0162\036.msg_type_def.e_msg_result"
    "_def:\ne_rmt_fail\022\022\n\npower_type\030\003 \001(\005\022\025\n\006"
    "is_buy\030\004 \001(\010:\005false\"~\n\027packetc2l_turret_"
    "rotate\022M\n\tpacket_id\030\001 \001(\0162!.fish_protoco"
    "ls.e_server_msg_type:\027e_mst_c2l_turret_r"
    "otate\022\024\n\014rotate_angle\030\002 \001(\005\"`\n\023packetc2l"
    "_sync_gold\022I\n\tpacket_id\030\001 \001(\0162!.fish_pro"
    "tocols.e_server_msg_type:\023e_mst_c2l_sync"
    "_gold\"\232\001\n\027packetl2c_bc_enter_seat\022M\n\tpac"
    "ket_id\030\001 \001(\0162!.fish_protocols.e_server_m"
    "sg_type:\027e_mst_l2c_bc_enter_seat\0220\n\tseat"
    "_info\030\002 \001(\0132\035.fish_protocols.msg_seat_in"
    "fo\"{\n\027packetl2c_bc_leave_seat\022M\n\tpacket_"
    "id\030\001 \001(\0162!.fish_protocols.e_server_msg_t"
    "ype:\027e_mst_l2c_bc_leave_seat\022\021\n\tplayer_i"
    "d\030\002 \001(\005\"\250\001\n\025packetl2c_robot_enter\022K\n\tpac"
    "ket_id\030\001 \001(\0162!.fish_protocols.e_server_m"
    "sg_type:\025e_mst_c2l_robot_enter\0220\n\tseat_i"
    "nfo\030\002 \001(\0132\035.fish_protocols.msg_seat_info"
    "\022\020\n\010scene_id\030\003 \001(\005\"w\n\025packetl2c_robot_le"
    "ave\022K\n\tpacket_id\030\001 \001(\0162!.fish_protocols."
    "e_server_msg_type:\025e_mst_l2c_robot_leave"
    "\022\021\n\tplayer_id\030\002 \001(\005\"\222\001\n\030packetl2c_bc_cha"
    "nge_rate\022N\n\tpacket_id\030\001 \001(\0162!.fish_proto"
    "cols.e_server_msg_type:\030e_mst_l2c_bc_cha"
    "nge_rate\022\021\n\tplayer_id\030\002 \001(\005\022\023\n\013turret_ra"
    "te\030\003 \001(\005\"\275\001\n\030packetl2c_bc_change_attr\022N\n"
    "\tpacket_id\030\001 \001(\0162!.fish_protocols.e_serv"
    "er_msg_type:\030e_mst_l2c_bc_change_attr\022\021\n"
    ...
    "c_create_fish\0220\n\tfish_info\030\002 \001(\0132\035.fish_"
    "protocols.msg_fish_info\"\377\001\n\035packetl2c_bc"
    "_create_generator\022S\n\tpacket_id\030\001 \001(\0162!.f"
    "ish_protocols.e_server_msg_type:\035e_mst_l"
    "2c_bc_create_generator\022\024\n\014generator_id\030\002"
    " \001(\005\022\020\n\010start_id\030\003 \001(\005\022\023\n\010route_id\030\004 \001(\005"
    ":\0010\022\025\n\006is_red\030\005 \001(\010:\005false\022\r\n\005pos_x\030\006 \001("
    "\005\022\r\n\005pos_y\030\007 \001(\005\022\027\n\010is_flash\030\010 \001(\010:\005fals"
    "e\"\353\001\n\025packetc2l_manual_fire\022K\n\tpacket_id"
    "\030\001 \001(\0162!.fish_protocols.e_server_msg_typ"
    "e:\025e_mst_c2l_manual_fire\022\021\n\tbullet_id\030\002 "
    "\001(\005\022\024\n\014bullet_angle\030\003 \001(\005\022\027\n\010is_multi\030\004 "
    "\001(\010:\005false\022\026\n\007is_fast\030\005 \001(\010:\005false\022\026\n\013bu"
    "llet_type\030\006 \001(\005:\0011\022\023\n\013bullet_rate\030\007 \001(\005\""
    "\203\001\n\032packetl2c_manual_fire_fail\022P\n\tpacket"
    "_id\030\001 \001(\0162!.fish_protocols.e_server_msg_"
    "type:\032e_mst_l2c_manual_fire_fail\022\023\n\013bull"
    "et_cost\030\002 \001(\005\"\327\001\n\030packetl2c_bc_manual_fi"
    "re\022N\n\tpacket_id\030\001 \001(\0162!.fish_protocols.e"
    "_server_msg_type:\030e_mst_l2c_bc_manual_fi"
    "re\022\021\n\tbullet_id\030\002 \001(\005\022\021\n\tplayer_id\030\003 \001(\005"
    "\022\024\n\014bullet_angle\030\004 \001(\005\022\027\n\010is_multi\030\005 \001(\010"
    ":\005false\022\026\n\013bullet_type\030\006 \001(\005:\0011\"\241\001\n\026pack"
    "etc2l_missile_fire\022L\n\tpacket_id\030\001 \001(\0162!."
    "fish_protocols.e_server_msg_type:\026e_mst_"
    "c2l_missile_fire\022\021\n\tbullet_id\030\002 \001(\005\022\022\n\nf"
    "ire_pos_x\030\003 \001(\005\022\022\n\nfire_pos_y\030\004 \001(\005\"\272\001\n\031"
    "packetl2c_bc_missile_fire\022O\n\tpacket_id\030\001"
    " \001(\0162!.fish_protocols.e_server_msg_type:"
    "\031e_mst_l2c_bc_missile_fire\022\021\n\tbullet_id\030"
    "\002 \001(\005\022\021\n\tplayer_id\030\003 \001(\005\022\022\n\nfire_pos_x\030\004"
    " \001(\005\022\022\n\nfire_pos_y\030\005 \001(\005\"\202\001\n\022packetc2l_h"
    ...
    "ketl2c_bc_turret_rotate\022P\n\tpacket_id\030\001 \001"
    "(\0162!.fish_protocols.e_server_msg_type:\032e"
    "_mst_l2c_bc_turret_rotate\022\021\n\tplayer_id\030\002"
    " \001(\005\022\024\n\014rotate_angle\030\003 \001(\005\"\232\001\n\035packetl2c"
    "_bc_change_max_power\022S\n\tpacket_id\030\001 \001(\0162"
    "!.fish_protocols.e_server_msg_type:\035e_ms"
    "t_l2c_bc_change_max_power\022\021\n\tplayer_id\030\002"
