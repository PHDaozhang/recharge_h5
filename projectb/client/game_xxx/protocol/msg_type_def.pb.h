...
const e_msg_result_def e_msg_result_def_MAX = e_rmt_bet_players_full;
...
const e_user_type e_user_type_MIN = e_user_type1;
const e_user_type e_user_type_MAX = e_user_type10;
const int e_user_type_ARRAYSIZE = e_user_type_MAX + 1;

const ::google::protobuf::EnumDescriptor* e_user_type_descriptor();
inline const ::std::string& e_user_type_Name(e_user_type value) {
  return ::google::protobuf::internal::NameOfEnum(
    e_user_type_descriptor(), value);
}
inline bool e_user_type_Parse(
    const ::std::string& name, e_user_type* value) {
  return ::google::protobuf::internal::ParseNamedEnum<e_user_type>(
    e_user_type_descriptor(), name, value);
}
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::msg_type_def::e_user_type>() {
  return ::msg_type_def::e_user_type_descriptor();
}
template <>
