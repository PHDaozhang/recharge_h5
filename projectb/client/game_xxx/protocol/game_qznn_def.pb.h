...
#ifndef PROTOBUF_game_5fqznn_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fqznn_5fdef_2eproto__INCLUDED
...
const e_notify_type e_notify_type_MAX = e_nt_shutdown;
...
const e_table_status e_table_status_MAX = e_ts_result;
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_qznn_protocols::e_server_msg_type>() {
  return ::game_qznn_protocols::e_server_msg_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_qznn_protocols::e_notify_type>() {
  return ::game_qznn_protocols::e_notify_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_qznn_protocols::e_table_status>() {
  return ::game_qznn_protocols::e_table_status_descriptor();
}
...
#endif  // PROTOBUF_game_5fqznn_5fdef_2eproto__INCLUDED
