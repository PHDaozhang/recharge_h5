...
#ifndef PROTOBUF_game_5fredblack_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fredblack_5fdef_2eproto__INCLUDED
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_redblack_protocols::e_server_msg_type>() {
  return ::game_redblack_protocols::e_server_msg_type_descriptor();
}
...
#endif  // PROTOBUF_game_5fredblack_5fdef_2eproto__INCLUDED
