...
#ifndef PROTOBUF_ebg_5fdef_2eproto__INCLUDED
#define PROTOBUF_ebg_5fdef_2eproto__INCLUDED
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ebg_protocols::e_server_msg_type>() {
  return ::ebg_protocols::e_server_msg_type_descriptor();
}
...
#endif  // PROTOBUF_ebg_5fdef_2eproto__INCLUDED
