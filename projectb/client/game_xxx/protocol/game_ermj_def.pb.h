...
#ifndef PROTOBUF_game_5fermj_5fdef_2eproto__INCLUDED
#define PROTOBUF_game_5fermj_5fdef_2eproto__INCLUDED
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_ermj_protocols::e_server_msg_type>() {
  return ::game_ermj_protocols::e_server_msg_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_ermj_protocols::e_notify_type>() {
  return ::game_ermj_protocols::e_notify_type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::game_ermj_protocols::e_action_code>() {
  return ::game_ermj_protocols::e_action_code_descriptor();
}
...
#endif  // PROTOBUF_game_5fermj_5fdef_2eproto__INCLUDED
