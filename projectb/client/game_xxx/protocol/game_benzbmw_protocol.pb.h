...
class packetl2c_bc_accept_gift : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:game_benzbmw_protocols.packetl2c_bc_accept_gift)
 private:
  inline void set_has_packet_id();
  inline void clear_has_packet_id();
  inline void set_has_player_id();
...
inline ::game_benzbmw_protocols::e_server_msg_type packetl2c_bc_accept_gift::packet_id() const {
  return static_cast< ::game_benzbmw_protocols::e_server_msg_type >(packet_id_);
}
inline void packetl2c_bc_accept_gift::set_packet_id(::game_benzbmw_protocols::e_server_msg_type value) {
  assert(::game_benzbmw_protocols::e_server_msg_type_IsValid(value));
  set_has_packet_id();
  packet_id_ = value;
}
