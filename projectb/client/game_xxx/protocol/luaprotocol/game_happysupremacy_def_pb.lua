...
module('game_happysupremacy_def_pb')
...
E_SERVER_MSG_TYPE_E_MST_C2L_GM_CHANGE_RESULT_ENUM = protobuf.EnumValueDescriptor();
...
E_SERVER_MSG_TYPE_E_MST_L2C_GM_CHANGE_RESULT_ENUM = protobuf.EnumValueDescriptor();
...
E_CARD_FLOWER = protobuf.EnumDescriptor();
E_CARD_FLOWER_E_FLOWER_DIAMOND_ENUM = protobuf.EnumValueDescriptor();
E_CARD_FLOWER_E_FLOWER_CLUB_ENUM = protobuf.EnumValueDescriptor();
E_CARD_FLOWER_E_FLOWER_SPADE_ENUM = protobuf.EnumValueDescriptor();
E_CARD_FLOWER_E_FLOWER_HEART_ENUM = protobuf.EnumValueDescriptor();
E_CARD_OWNER = protobuf.EnumDescriptor();
E_CARD_OWNER_E_OWNER_NONE_ENUM = protobuf.EnumValueDescriptor();
E_CARD_OWNER_E_OWNER_BANKER_ENUM = protobuf.EnumValueDescriptor();
E_CARD_OWNER_E_OWNER_FORWARDDOOR_ENUM = protobuf.EnumValueDescriptor();
E_CARD_OWNER_E_OWNER_REVERSEDOOR_ENUM = protobuf.EnumValueDescriptor();
E_CARD_OWNER_E_OWNER_OPPOSITEDOOR_ENUM = protobuf.EnumValueDescriptor();
E_BET_TYPE = protobuf.EnumDescriptor();
E_BET_TYPE_E_BETTYPE_FORWARDDOOR_ENUM = protobuf.EnumValueDescriptor();
E_BET_TYPE_E_BETTYPE_REVERSEDOOR_ENUM = protobuf.EnumValueDescriptor();
E_BET_TYPE_E_BETTYPE_OPPOSITEDOOR_ENUM = protobuf.EnumValueDescriptor();
E_BET_TYPE_E_BETTYPE_FORWARD_OPPOSITE_DOOR_ENUM = protobuf.EnumValueDescriptor();
E_BET_TYPE_E_BETTYPE_REVERSE_OPPOSITE_DOOR_ENUM = protobuf.EnumValueDescriptor();
E_BET_TYPE_E_BETTYPE_FORWARD_REVERSE_DOOR_ENUM = protobuf.EnumValueDescriptor();
E_BET_TYPE_E_BETTYPE_ALL_KILL_ENUM = protobuf.EnumValueDescriptor();
E_BET_TYPE_E_BETTYPE_ALL_PAY_ENUM = protobuf.EnumValueDescriptor();
E_BET_RESULT = protobuf.EnumDescriptor();
E_BET_RESULT_E_BETRESULT_NOWIN_NOLOSE_ENUM = protobuf.EnumValueDescriptor();
E_BET_RESULT_E_BETRESULT_WIN_ENUM = protobuf.EnumValueDescriptor();
E_BET_RESULT_E_BETRESULT_LOSE_ENUM = protobuf.EnumValueDescriptor();
...
E_SERVER_MSG_TYPE_E_MST_C2L_LEAVE_LIST_BANKER_ENUM.index = 16
E_SERVER_MSG_TYPE_E_MST_C2L_LEAVE_LIST_BANKER_ENUM.number = 10016
E_SERVER_MSG_TYPE_E_MST_C2L_GM_CHANGE_RESULT_ENUM.name = "e_mst_c2l_gm_change_result"
E_SERVER_MSG_TYPE_E_MST_C2L_GM_CHANGE_RESULT_ENUM.index = 17
E_SERVER_MSG_TYPE_E_MST_C2L_GM_CHANGE_RESULT_ENUM.number = 11001
...
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_LIST_BANKER_ENUM.index = 39
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_LIST_BANKER_ENUM.number = 15024
E_SERVER_MSG_TYPE_E_MST_L2C_GM_CHANGE_RESULT_ENUM.name = "e_mst_l2c_gm_change_result"
E_SERVER_MSG_TYPE_E_MST_L2C_GM_CHANGE_RESULT_ENUM.index = 40
E_SERVER_MSG_TYPE_E_MST_L2C_GM_CHANGE_RESULT_ENUM.number = 16001
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_GM_ALL_BET_INFO_ENUM.name = "e_mst_l2c_notice_gm_all_bet_info"
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_GM_ALL_BET_INFO_ENUM.index = 41
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_GM_ALL_BET_INFO_ENUM.number = 16100
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_GM_BANK_INFO_ENUM.number = 16101
...
E_SERVER_MSG_TYPE_E_MST_ATTENTION_NEEDLEAVE_ENUM.number = 16102
E_SERVER_MSG_TYPE_E_MST_L2C_BC_DEBUGINFO_ENUM.name = "e_mst_l2c_bc_debuginfo"
E_SERVER_MSG_TYPE_E_MST_L2C_BC_DEBUGINFO_ENUM.index = 44
...
E_GAME_STATE.full_name = ".game_happysupremacy_protocols.e_game_state"
...
E_CARD_FLOWER_E_FLOWER_DIAMOND_ENUM.name = "e_flower_diamond"
E_CARD_FLOWER_E_FLOWER_DIAMOND_ENUM.index = 0
E_CARD_FLOWER_E_FLOWER_DIAMOND_ENUM.number = 0
E_CARD_FLOWER_E_FLOWER_CLUB_ENUM.name = "e_flower_club"
E_CARD_FLOWER_E_FLOWER_CLUB_ENUM.index = 1
E_CARD_FLOWER_E_FLOWER_CLUB_ENUM.number = 1
E_CARD_FLOWER_E_FLOWER_SPADE_ENUM.name = "e_flower_spade"
E_CARD_FLOWER_E_FLOWER_SPADE_ENUM.index = 2
E_CARD_FLOWER_E_FLOWER_SPADE_ENUM.number = 2
E_CARD_FLOWER_E_FLOWER_HEART_ENUM.name = "e_flower_heart"
E_CARD_FLOWER_E_FLOWER_HEART_ENUM.index = 3
E_CARD_FLOWER_E_FLOWER_HEART_ENUM.number = 3
E_CARD_FLOWER.name = "e_card_flower"
E_CARD_FLOWER.full_name = ".game_happysupremacy_protocols.e_card_flower"
E_CARD_FLOWER.values = {E_CARD_FLOWER_E_FLOWER_DIAMOND_ENUM,E_CARD_FLOWER_E_FLOWER_CLUB_ENUM,E_CARD_FLOWER_E_FLOWER_SPADE_ENUM,E_CARD_FLOWER_E_FLOWER_HEART_ENUM}
E_CARD_OWNER_E_OWNER_NONE_ENUM.name = "e_owner_none"
E_CARD_OWNER_E_OWNER_NONE_ENUM.index = 0
E_CARD_OWNER_E_OWNER_NONE_ENUM.number = 0
E_CARD_OWNER_E_OWNER_BANKER_ENUM.name = "e_owner_banker"
E_CARD_OWNER_E_OWNER_BANKER_ENUM.index = 1
E_CARD_OWNER_E_OWNER_BANKER_ENUM.number = 1
E_CARD_OWNER_E_OWNER_FORWARDDOOR_ENUM.name = "e_owner_forwarddoor"
E_CARD_OWNER_E_OWNER_FORWARDDOOR_ENUM.index = 2
E_CARD_OWNER_E_OWNER_FORWARDDOOR_ENUM.number = 2
E_CARD_OWNER_E_OWNER_REVERSEDOOR_ENUM.name = "e_owner_reversedoor"
E_CARD_OWNER_E_OWNER_REVERSEDOOR_ENUM.index = 3
E_CARD_OWNER_E_OWNER_REVERSEDOOR_ENUM.number = 3
E_CARD_OWNER_E_OWNER_OPPOSITEDOOR_ENUM.name = "e_owner_oppositedoor"
E_CARD_OWNER_E_OWNER_OPPOSITEDOOR_ENUM.index = 4
E_CARD_OWNER_E_OWNER_OPPOSITEDOOR_ENUM.number = 4
E_CARD_OWNER.name = "e_card_owner"
E_CARD_OWNER.full_name = ".game_happysupremacy_protocols.e_card_owner"
E_CARD_OWNER.values = {E_CARD_OWNER_E_OWNER_NONE_ENUM,E_CARD_OWNER_E_OWNER_BANKER_ENUM,E_CARD_OWNER_E_OWNER_FORWARDDOOR_ENUM,E_CARD_OWNER_E_OWNER_REVERSEDOOR_ENUM,E_CARD_OWNER_E_OWNER_OPPOSITEDOOR_ENUM}
E_BET_TYPE_E_BETTYPE_FORWARDDOOR_ENUM.name = "e_bettype_forwarddoor"
E_BET_TYPE_E_BETTYPE_FORWARDDOOR_ENUM.index = 0
E_BET_TYPE_E_BETTYPE_FORWARDDOOR_ENUM.number = 1
E_BET_TYPE_E_BETTYPE_REVERSEDOOR_ENUM.name = "e_bettype_reversedoor"
E_BET_TYPE_E_BETTYPE_REVERSEDOOR_ENUM.index = 1
E_BET_TYPE_E_BETTYPE_REVERSEDOOR_ENUM.number = 2
E_BET_TYPE_E_BETTYPE_OPPOSITEDOOR_ENUM.name = "e_bettype_oppositedoor"
E_BET_TYPE_E_BETTYPE_OPPOSITEDOOR_ENUM.index = 2
E_BET_TYPE_E_BETTYPE_OPPOSITEDOOR_ENUM.number = 3
E_BET_TYPE_E_BETTYPE_FORWARD_OPPOSITE_DOOR_ENUM.name = "e_bettype_forward_opposite_door"
E_BET_TYPE_E_BETTYPE_FORWARD_OPPOSITE_DOOR_ENUM.index = 3
E_BET_TYPE_E_BETTYPE_FORWARD_OPPOSITE_DOOR_ENUM.number = 4
E_BET_TYPE_E_BETTYPE_REVERSE_OPPOSITE_DOOR_ENUM.name = "e_bettype_reverse_opposite_door"
E_BET_TYPE_E_BETTYPE_REVERSE_OPPOSITE_DOOR_ENUM.index = 4
E_BET_TYPE_E_BETTYPE_REVERSE_OPPOSITE_DOOR_ENUM.number = 5
E_BET_TYPE_E_BETTYPE_FORWARD_REVERSE_DOOR_ENUM.name = "e_bettype_forward_reverse_door"
E_BET_TYPE_E_BETTYPE_FORWARD_REVERSE_DOOR_ENUM.index = 5
E_BET_TYPE_E_BETTYPE_FORWARD_REVERSE_DOOR_ENUM.number = 6
E_BET_TYPE_E_BETTYPE_ALL_KILL_ENUM.name = "e_bettype_all_kill"
E_BET_TYPE_E_BETTYPE_ALL_KILL_ENUM.index = 6
E_BET_TYPE_E_BETTYPE_ALL_KILL_ENUM.number = 7
E_BET_TYPE_E_BETTYPE_ALL_PAY_ENUM.name = "e_bettype_all_pay"
E_BET_TYPE_E_BETTYPE_ALL_PAY_ENUM.index = 7
E_BET_TYPE_E_BETTYPE_ALL_PAY_ENUM.number = 8
E_BET_TYPE.name = "e_bet_type"
E_BET_TYPE.full_name = ".game_happysupremacy_protocols.e_bet_type"
E_BET_TYPE.values = {E_BET_TYPE_E_BETTYPE_FORWARDDOOR_ENUM,E_BET_TYPE_E_BETTYPE_REVERSEDOOR_ENUM,E_BET_TYPE_E_BETTYPE_OPPOSITEDOOR_ENUM,E_BET_TYPE_E_BETTYPE_FORWARD_OPPOSITE_DOOR_ENUM,E_BET_TYPE_E_BETTYPE_REVERSE_OPPOSITE_DOOR_ENUM,E_BET_TYPE_E_BETTYPE_FORWARD_REVERSE_DOOR_ENUM,E_BET_TYPE_E_BETTYPE_ALL_KILL_ENUM,E_BET_TYPE_E_BETTYPE_ALL_PAY_ENUM}
E_BET_RESULT_E_BETRESULT_NOWIN_NOLOSE_ENUM.name = "e_betresult_nowin_nolose"
E_BET_RESULT_E_BETRESULT_NOWIN_NOLOSE_ENUM.index = 0
E_BET_RESULT_E_BETRESULT_NOWIN_NOLOSE_ENUM.number = 1
E_BET_RESULT_E_BETRESULT_WIN_ENUM.name = "e_betresult_win"
E_BET_RESULT_E_BETRESULT_WIN_ENUM.index = 1
E_BET_RESULT_E_BETRESULT_WIN_ENUM.number = 2
E_BET_RESULT_E_BETRESULT_LOSE_ENUM.name = "e_betresult_lose"
E_BET_RESULT_E_BETRESULT_LOSE_ENUM.index = 2
E_BET_RESULT_E_BETRESULT_LOSE_ENUM.number = 3
E_BET_RESULT.name = "e_bet_result"
E_BET_RESULT.full_name = ".game_happysupremacy_protocols.e_bet_result"
E_BET_RESULT.values = {E_BET_RESULT_E_BETRESULT_NOWIN_NOLOSE_ENUM,E_BET_RESULT_E_BETRESULT_WIN_ENUM,E_BET_RESULT_E_BETRESULT_LOSE_ENUM}

e_betresult_lose = 3
e_betresult_nowin_nolose = 1
e_betresult_win = 2
e_bettype_all_kill = 7
e_bettype_all_pay = 8
...
e_flower_heart = 3
e_flower_spade = 2
e_mst_attention_needLeave = 16102
...
e_mst_c2l_leave_list_banker = 10016
