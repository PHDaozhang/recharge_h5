...
(function (cui) {
    ...
    var BaseContainer = (function (_super) {
        ...
        BaseContainer.prototype.validateNow = function () {
            var self = this;
            if (self.$BC[9 /* openLayout */]) {
                self.updateDL();
            }
        };
        //--------------------------------------------
        BaseContainer.prototype.invalidateDL = function () {
            ...
            if (self.$stage && !self._invalidDLFlag) {
                ...
                if (parent_1 && parent_1.isOpenLayout) {
                    parent_1.invalidateDL();
                }
        ...
        BaseContainer.prototype.$measureChildBounds = function (bounds) {
        };
...
(function (cui) {
    var Component = (function (_super) {
        ...
        Component.prototype.setSkin = function (newSkin) {
            if (true) {
                if (newSkin && !(newSkin instanceof cui.Skin)) {
                    egret.log("error: not find skin skinName=" + this.skinName);
                    return;
                }
            }
            var self = this;
...
(function (cui) {
    var Group = (function (_super) {
        ...
        Group.prototype.validateNow = function () {
            ...
            //}
            //else if( self.$BC[BaseUIKeys.openLayout] )
            //{
            //    self.updateDL( self.$getWidth(), self.$getHeight() );
            //}
        };
...
(function (TRain) {
    ...
    var AssetManager = (function () {
        ...
        AssetManager.prototype.getFont = function (name, cb, thisObject) {
            ...
            RES.getResByUrl(CONF.fontUrl + name + ".fnt", callBack, thisObject, "fnt" /* FONT */);
        };
        ...
        AssetManager.prototype.createBitmapData = function (data, callback) {
            var img = new Image();
    ...
    var SheetAnalyzer = (function (_super) {
        ...
        SheetAnalyzer.prototype.onLoadFinish = function (event) {
            ...
            if (resItem.loaded) {
                ...
                TRain.assetMgr.createBitmapData(imgArr, function (bitmapData) {
...
(function (EaseUtil) {
    ...
    function getQuakeFun(waveCnt, decayPer) {
        ...
        return function (t) {
            var tmp = t * waveCnt;
            var radian = (tmp - Math.floor(tmp)) * pi2;
...
var CONF;
(function (CONF) {
    CONF.sheetUrl = "resource/sheets/"; //sheet 资源目录
    CONF.fontUrl = "resource/fonts/"; //font 资源目录
    CONF.mcUrl = "resource/mcs/"; //mc 资源目录
    CONF.soundUrl = "resource/sound/";
...
(function (TRain) {
    var Core = (function () {
        ...
        Core.prototype.init = function (s) {
            ...
            s.addEventListener(egret.Event.ACTIVATE, self.redrawStage, self);
            self._lastTime = egret.getTimer();
            cui.uiMgr.initState(s);
        };
        Core.prototype.redrawStage = function () {
        ...
        Core.prototype.update = function (e) {
            var self = this;
...
(function (TRain) {
    var MCManager = (function () {
        ...
        MCManager.prototype.enableGC = function () {
            var self = this;
            if (self._timeoutHandler == 0) {
                self._disposeTp = 0;
                self._timeoutHandler = TRain.core.addDelayDo(self.disposeRess, self, CONF.mcGCTm);
            }
        };
        MCManager.prototype.disableGC = function () {
            var self = this;
            if (self._timeoutHandler !== 0) {
...
(function (TRain) {
    ...
    (function (UITheme) {
        ...
        function mergeSkins(addConfs) {
            var skinConfs = _skinConfs;
            for (var key in addConfs) {
                var confs = addConfs[key];
                for (var subkey in confs) {
                    skinConfs["skins." + key + "." + subkey] = confs[subkey];
                }
            }
        }
        UITheme.mergeSkins = mergeSkins;
        function getSkin(name) {
            var self = this;
            var cls = _skinMap[name];
            if (cls)
                return cls;
            return parseSkin(name);
        }
        UITheme.getSkin = getSkin;
        // function getSkinNames( skinName:string ):{first:string, secound:string}
        // {
        //     let startIdx = skinName.indexOf( "." ) + 1;
        //     let dotIdx = skinName.indexOf( ".", startIdx );
        ...
        function updateInitParse(tm) {
            var self = this;
            var initSkins = _skinConfs;
            var handle = false;
        ...
        function parseSkin(name) {
            ...
            skinConf = skinConf.replace(/#b/g, "function(");
...
(function (TRain) {
    var WebVerController = (function () {
        ...
        WebVerController.prototype.fetchVersion = function (callback) {
            ...
            request.open(CONF.resHome + CONF.verFile);
            request.send();
        };
    ...
    var ActionSequence = (function (_super) {
        ...
        ActionSequence.prototype.update = function (tm) {
            ...
            while (curIdx < actions.length) {
                ...
                var split = self._curSplit + self._lastSplit;
                if (tm >= split) {
                    curAction.update(1);
                    curAction.stop();
                    curIdx++;
...
(function (TRain) {
    ...
    TRain.soundMgr = new SoundManager();
})(TRain || (TRain = {}));
var cui;
(function (cui) {
    /**
    ...
    var ScaleButton = (function (_super) {
        ...
        Object.defineProperty(ScaleButton.prototype, "label", {
            // public get source():any
            // {
            //     return this._src;
            // }
        ...
        Object.defineProperty(ScaleButton.prototype, "txtKey", {
            get: function () {
                return this._txtKey;
            },
            set: function (value) {
        ...
        Object.defineProperty(ScaleButton.prototype, "icon", {
            get: function () {
                return this._icon;
            },
            set: function (value) {
        ...
        Object.defineProperty(ScaleButton.prototype, "sound", {
            get: function () {
                return this._sound;
            },
            set: function (value) {
        ...
        ScaleButton.prototype.setTarget = function (fun, tar) {
            this._cb = { fun: fun, tar: tar };
        };
        ScaleButton.prototype.$hitTest = function (stageX, stageY) {
            var self = this;
            if (!self.touchEnabled || !self.visible)
                return null;
            var point = self.globalToLocal(stageX, stageY, egret.$TempPoint);
        ...
        ScaleButton.prototype.onTouchEnd = function (event) {
            var self = this;
            self.onTouchFinish();
            //此事件 以被别的控件处理了
            if (event.isDefaultPrevented())
