...
declare module TRain {
    ...
    class AssetManager {
        ...
        createBitmapData(data: any, callback: any): void;
    }
...
declare module TRain {
    module UITheme {
        ...
        function addSkinConf(addConfs: any): void;
        function mergeSkins(addConfs: any): void;
...
declare module cui {
    ...
    class ScaleButton extends Component {
        ...
        icon: string;
        sound: string;
        setTarget(fun: (ctrl: ScaleButton) => void, tar: any): void;
        $hitTest(stageX: number, stageY: number): egret.DisplayObject;
        protected _tempStage: egret.Stage;
        protected onTouchBegin(event: egret.TouchEvent): void;
        private onTouchEnd(event);
